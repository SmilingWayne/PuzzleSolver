...
class ABCEndViewSolver(PuzzleSolver):
    def __init__(self, data: dict[str, Any]):
        ...
        self.cols_top: List[str] = self._data['cols_1']
        self.cols_bottom: List[str] = self._data['cols_2']
        self.rows_left: List[str] = self._data['rows_1']
        self.rows_right: List[str] = self._data['rows_2']
        
        self.val: int = self._char_to_int(self._data['val'] )
