...
class ButterflySudokuParser(BasePuzzleParser):
    """(Butterfly) Sudoku parser"""
    
    def __init__(self):
        super().__init__("ButterflySudoku")
    ...
    def parse_puzzle_from_str(self, content: str) -> Optional[Dict]:
        try:
            ...
            if not m.isdigit() or not n.isdigit() or int(m) != 12 or int(n) != 12:
