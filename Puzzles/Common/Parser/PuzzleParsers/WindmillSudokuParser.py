...
class WindmillSudokuParser(BasePuzzleParser):
    """WindmillSudoku parser"""
    
    def __init__(self):
        super().__init__("WindmillSudoku")
    ...
    def parse_puzzle_from_str(self, content: str) -> Optional[Dict]:
        try:
            ...
            if not m.isdigit() or not n.isdigit() or int(m) != 21 or int(n) != 21:
