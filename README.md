...
This repo provides useful, problem-tailored solvers for some interesting **logic puzzles**. The tool used in the repo is Google Operations Research software [ORtools](https://developers.google.cn/optimization?hl=zh-cn), and [z3 solver](https://github.com/Z3Prover/z3), mainly CS-SAT solver. Commercial solver [Gurobi](https://www.gurobi.com) (Licence required, of course) is also used for specific puzzle (Like [Slitherlink](./Puzzles/SlitherLink.ipynb)).
