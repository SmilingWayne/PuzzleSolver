...
> 📖 **Rule Reference**: [Read full rules on external site](https://www.janko.at/Raetsel/Sudoku/Clueless-1/index.htm)

🎮 **Play Online**: [Janko](https://www.janko.at/Raetsel/Sudoku/Clueless-1/001.a.htm)
...
# Solve
res = puzzlekit.solve(problem_str, puzzle_type="clueless_1_sudoku")
