...
> 📖 **Rule Reference**: [Read full rules on external site](https://www.janko.at/Raetsel/Sudoku/Gattai-8/index.htm)

🎮 **Play Online**: [Janko](https://www.janko.at/Raetsel/Sudoku/Gattai-8/001.a.htm)
...
# Solve
res = puzzlekit.solve(problem_str, puzzle_type="gattai_8_sudoku")
